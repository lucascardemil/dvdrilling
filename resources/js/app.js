...
Vue.component('index-personal-component', require('./components/Personal/IndexComponent.vue').default);
Vue.component('roles-component', require('./components/Roles/RolesComponent.vue').default);
Vue.component('index-activo-component', require('./components/Activo/IndexComponent.vue').default);
...
Vue.component('index-recurso-component', require('./components/Recurso/IndexComponent.vue').default);
