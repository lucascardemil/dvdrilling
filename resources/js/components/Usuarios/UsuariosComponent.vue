        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                <button type="button" class="btn btn-base-dv" @click="openCrearModal()"><i
                        class="bi bi-plus-circle"></i> Agregar Usuario</button>
            </div>
        </div>
                ...
                <tbody>
                    <template v-if="usuarios.length">
                        <tr v-for="(usuario, index) in usuarios" :key="usuario.id">
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" @click="openEditModal(usuario)"><i class="bi bi-pencil-square"></i> Editar
                                    Rol</button>
                            </td>
                        </tr>
                    </template>
